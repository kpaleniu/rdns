...
- **#33** — a fourth review pass, filed 2026-09-05: duplication, generics, and
  where the modules are cut. Eight items, of which **seven are done** (33a-33g —
  33b was the one defect in a shipped binary, `rdnsc` unable to ask an ANY
  query) and one is open: 33h, eight preventative lines. Five further candidates
  were dropped and the section says why, which is the half of it worth reading.
...
>
> **2. The rest of #33**: **33h**, eight preventative lines, when that code is
> next opened. Everything else in the section is closed.
...
rather than the `pub mod testing` the first draft wanted. What is left is
**33h**, worth doing when that code is next opened and not before.
