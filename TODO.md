...
- **#33** — a fourth review pass, filed 2026-09-05: duplication, generics, and
  where the modules are cut. Eight items, of which **six are done** (33a-33f —
  33b was the one defect in a shipped binary, `rdnsc` unable to ask an ANY
  query) and two are open: 33g, the test fixtures, and 33h, eight preventative
  lines. Five further candidates were dropped and the section says why, which is
  the half of it worth reading.
...
>
> **2. The rest of #33**: **33g**, the fixtures, and **33h**, eight preventative
> lines. Everything else in the section is closed.
...
**33d and 33e are done too, and 33f rode along with 33d.** What is left is
**33g**, unblocked by 33b — what it inherits is `with_query` taking a `Qtype`
rather than the `pub mod testing` the first draft wanted. **33h** is worth doing
when that code is next opened and not before.
